# Multimessenger Astronomy {.unnumbered}
...
$$n_0 L_\nu \sim 10^{43} \frac\mathrm{{erg}}\mathrm{{Mpc}^3\rm{yr}}$$
...
$$n_0^{-1/3} \leq \frac{\Phi^{u.l.}}{10^{43}\frac\mathrm{{erg}}\mathrm{{Mpc}^3\rm{yr}} }$$
...
print("$n_0 \geq$ {0:.1e} {1}".format(n0.value, n0.unit.to_string("latex_inline")))
```
