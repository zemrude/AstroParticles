...
![Source: [arXiv:1210.5154](http://arxiv.org/abs/1210.5154)](images/nu_zenith.png){width="40%"}
...
![](images/muon_ionization.svg){width="30%"}
...
![](images/muon_bremsstrahlung.svg){width="30%"}
...
![](images/muon_pair-production.svg){width="30%"}
...
![](images/muon_photonuclear.svg){width="30%"}
...
![](images/muon_energylosses.svg){width="80%"}
...
![](images/neutrino-interactions.svg)
...
At $E_\nu \gg 1$ GeV the total DIS cross-section (ie, assuming CC and NC together) can be approximated to:
...
print (f"The mean free path is: {L.to(u.km)}")
```
...
![Source: [arXiv:1205.2671](https://inspirehep.net/record/1114323)](https://inspirehep.net/record/1114323/files/Neutrinos_figs_3nuspic.png)
